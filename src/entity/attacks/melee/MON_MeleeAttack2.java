...
public class MON_MeleeAttack2 extends Entity {
    ...
    int multiplier;
    public MON_MeleeAttack2(GamePanel gp, int duration, String Melee_AttackDirection, int Melee_attackRange, Entity originEntity){
        super(gp);
        this.gp = gp;
